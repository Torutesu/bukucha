...
[SCR-001, SCR-002, SCR-003, SCR-005, SCR-006, SCR-007, SCR-009, SCR-010, SCR-011,
 SCR-012, SCR-014, SCR-015, SCR-017, SCR-018, SCR-020, SCR-021, SCR-022, SCR-024, SCR-025]

**19画面。**うち SCR-021 / 022 / 024 / 025 は v1 に存在しなかった、この方針転換の中核。
...
| # | 条件 | 状態 |
|---|---|---|
| 1 | **E2E P0 23件を含む27件が全通過** | ✅ 達成(連続2回グリーン) |
...
- 画面: **19**
- E2E: **27**(P0 23 / P1 4)— 全通過
- AIF: **10**(すべて fallback 定義済み)
- スキーマ: **24モデル + 12 enum**
